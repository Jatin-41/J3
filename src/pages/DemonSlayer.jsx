    ...
    >
      ...
      <div className="canvas-hero demon-slayer" ref={heroRef}>
        ...
        <div className="canvas-logo">
          ...
          <div className="sub-tag">CRIMSON&nbsp;&nbsp;BLADE &nbsp;·&nbsp; BREATH OF THE SUN</div>
        </div>

        <div className="canvas-content">
          <div className="canvas-left">
            <span className="canvas-eyebrow demon-slayer">Demon Slayer Corps</span>
            <h1 className="canvas-title demon-slayer">
              TANJIRO<br />KAMADO
            </h1>
            <p className="canvas-desc">
              A boy who lost everything to demons, yet chose compassion over hatred. 
              Wielding Total Concentration Breathing and a gentle heart sharper than any blade.
            </p>
            <button className="canvas-btn demon-slayer">Slay the Demon</button>
          </div>

          <div className="canvas-right">
            <span className="canvas-eyebrow ds-right">The Chosen One</span>
            <h1 className="canvas-title demon-slayer ds-right">
              YORIICHI<br />TSUGIKUNI
            </h1>
            <p className="canvas-desc">
              The first and greatest Demon Slayer to ever live. Creator of the 
              Breath of the Sun — the only one who ever brought Muzan to his knees.
            </p>
          </div>
        </div>

        <div className="canvas-hint" ref={hintRef}>
          ▸ MOVE ACROSS TO REVEAL THE SUN BREATHER ◂
        </div>
      </div>
    </motion.div>
  )
