  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      if (trail.length) {
        ...
        glow.addColorStop(0, 'rgba(220,30,60,0.35)')
        glow.addColorStop(0.45, 'rgba(160,0,30,0.16)')
    ...
    >
      ...
      <div className="canvas-hero demon-slayer" ref={heroRef}>
        ...
        <div className="canvas-logo">
          <div className="main-title demon-slayer">Demon Slayer</div>
          <div className="sub-tag">UPPER&nbsp;&nbsp;MOON &nbsp;·&nbsp; BREATH OF THE SUN</div>
        </div>

        <div className="canvas-content">
          {/* LEFT SIDE - KOKUSHIBO */}
          <div className="canvas-left">
            <span className="canvas-eyebrow demon-slayer">Upper Moon One</span>
            <h1 className="canvas-title demon-slayer">
              KOKUSHIBO<br />MOON
            </h1>
            <p className="canvas-desc">
              Once a demon slayer who grew jealous of his twin brother's 
              unmatched talent. He abandoned his humanity, becoming the 
              strongest demon under Muzan, wielding the Moon Breathing.
            </p>
            <button className="canvas-btn demon-slayer">Face the Moon</button>
          </div>

          {/* RIGHT SIDE - YORIICHI */}
          <div className="canvas-right">
            <span className="canvas-eyebrow ds-right">The Sun God</span>
            <h1 className="canvas-title demon-slayer ds-right">
              YORIICHI<br />SUN
            </h1>
            <p className="canvas-desc">
              Kokushibo's twin brother, blessed with the Sun Breathing technique. 
              The strongest swordsman in history, who almost defeated Muzan. 
              His talent overshadowed his brother, creating an eternal rift.
            </p>
          </div>
        </div>

        <div className="canvas-hint" ref={hintRef}>
          ▸ MOVE ACROSS TO REVEAL THE TWIN LEGACY ◂
        </div>
      </div>
    </motion.div>
  )
