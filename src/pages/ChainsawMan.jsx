...
export default function ChainsawMan() {
    ...
    useEffect(() => {
        ...
        const top = new Image()
        bottom.src = chainsawBg
        top.src = chainsawReveal
        ...
        function draw() {
            ...
            if (trail.length) {
                ...
                glow.addColorStop(0, 'rgba(255,50,50,0.28)') // Blood red glow
                glow.addColorStop(0.45, 'rgba(200,30,30,0.12)')
        ...
        >
            ...
            <div className="canvas-hero chainsaw" ref={heroRef}>
                ...
                <div className="canvas-logo">
                    <div className="main-title chainsaw">Chainsaw Man</div>
                    <div className="sub-tag">DEVIL HUNTER &nbsp;·&nbsp; THE CHAINSAW DEVIL</div>
                </div>

                <div className="canvas-content">
                    <div className="canvas-left">
                        <span className="canvas-eyebrow chainsaw">Public Safety Devil Hunters</span>
                        <h1 className="canvas-title chainsaw">
                            DENJI<br />CHAINSAW
                        </h1>
                        <p className="canvas-desc">
                            A young man burdened by debt, who bonds with his pet devil Pochita
                            to become the Chainsaw Man. He fights devils with reckless abandon,
                            dreaming of a simple life with food and... physical affection.
                        </p>
                        <button className="canvas-btn chainsaw">Kick Some Devil Ass</button>
                    </div>

                    <div className="canvas-right">
                        <span className="canvas-eyebrow chainsaw-right">The Bomb Devil</span>
                        <h1 className="canvas-title chainsaw chainsaw-right">
                            REZE<br />BOMB
                        </h1>
                        <p className="canvas-desc">
                            A devil hunter with a gentle smile and a deadly secret.
                            As the Bomb Devil, she is sent to assassinate Denji,
                            but her feelings blur the line between mission and love.
                            She offers him a normal life, but fate has other plans.
                        </p>
                    </div>
                </div>

                <div className="canvas-hint" ref={hintRef}>
                    ▸ MOVE TO REVEAL THE CHAINSAW ◂
                </div>
            </div>
        </motion.div>
    )
