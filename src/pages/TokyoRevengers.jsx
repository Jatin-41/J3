...
export default function TokyoRevengers() {
  ...
  useEffect(() => {
    ...
    const top = new Image()
    bottom.src = tokyoRevBg
    top.src = tokyoRevReveal
    ...
    function draw() {
      ...
      if (trail.length) {
        ...
        glow.addColorStop(0, 'rgba(255,0,0,0.28)')
        glow.addColorStop(0.45, 'rgba(180,0,0,0.12)')
  ...
  return (
    ...
    >
      <Link to="/anime" className="back-btn tokyo-rev">← Back</Link>

      <div className="canvas-hero tokyo-rev" ref={heroRef}>
        <canvas className="canvas-element" ref={canvasRef} />

        <div className="canvas-logo">
          <div className="main-title tokyo-rev">Tokyo Revengers</div>
          <div className="sub-tag">TOMAN &nbsp;·&nbsp; THE REVENGERS</div>
        </div>

        <div className="canvas-content">
          {/* LEFT SIDE - IZANA KUROKAWA */}
          <div className="canvas-left">
            <span className="canvas-eyebrow tokyo-rev">Tenjiku · The Mastermind</span>
            <h1 className="canvas-title tokyo-rev">
              IZANA<br />KUROKAWA
            </h1>
            <p className="canvas-desc">
              The charismatic and ruthless leader of Tenjiku. 
              Born with a silver spoon, he despises weakness and 
              views the world as his personal playground. 
              His ultimate goal — crush Toman and prove his superiority.
            </p>
            <button className="canvas-btn tokyo-rev">Join Tenjiku</button>
          </div>

          {/* RIGHT SIDE - MANJIRO SANO (MIKEY) */}
          <div className="canvas-right">
            <span className="canvas-eyebrow tokyo-rev-right">The Invincible Mikey</span>
            <h1 className="canvas-title tokyo-rev tokyo-rev-right">
              MANJIRO<br />SANOO
            </h1>
            <p className="canvas-desc">
              The legendary leader of Tokyo Manji Gang. 
              Known as "Mikey," he is the strongest fighter 
              with a heart of gold. But darkness lurks within — 
              a darkness that threatens to consume everything he loves.
            </p>
          </div>
        </div>

        <div className="canvas-hint" ref={hintRef}>
          ▸ MOVE ACROSS TO REVEAL THE REVENGER ◂
        </div>
      </div>
    </motion.div>
  )
