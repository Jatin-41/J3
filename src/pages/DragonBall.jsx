...
export default function DragonBall() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      if (trail.length) {
        ...
        glow.addColorStop(0, 'rgba(255,220,0,0.40)')
        glow.addColorStop(0.45, 'rgba(255,140,0,0.18)')
  ...
  return (
    ...
    >
      <Link to="/anime" className="back-btn dragonball">← Back</Link>

      <div className="canvas-hero dragonball" ref={heroRef}>
        <canvas className="canvas-element" ref={canvasRef} />

        <div className="canvas-logo">
          <div className="main-title dragonball">Dragon Ball</div>
          <div className="sub-tag">ULTRA&nbsp;&nbsp;INSTINCT &nbsp;·&nbsp; SUPER SAIYAN</div>
        </div>

        <div className="canvas-content">
          <div className="canvas-left">
            <span className="canvas-eyebrow dragonball">Saiyan Born on Earth</span>
            <h1 className="canvas-title dragonball">
              SON<br />GOKU
            </h1>
            <p className="canvas-desc">
              A pure-hearted Saiyan raised on Earth. His insatiable hunger for 
              battle and growth has pushed him beyond every limit — from Super Saiyan 
              to Ultra Instinct.
            </p>
            <button className="canvas-btn dragonball">Power Up!</button>
          </div>

          <div className="canvas-right">
            <span className="canvas-eyebrow db-right">Prince of All Saiyans</span>
            <h1 className="canvas-title dragonball db-right">
              VEGETA
            </h1>
            <p className="canvas-desc">
              Proud prince of the fallen Saiyan race. His rivalry with Goku 
              drives him to transcend pride, hatred, and his own limits — 
              becoming Ultra Ego.
            </p>
          </div>
        </div>
        ...
        <div className="canvas-hint" ref={hintRef}>
          ▸ MOVE ACROSS TO POWER UP VEGETA ◂
        </div>
      </div>
    </motion.div>
  )
